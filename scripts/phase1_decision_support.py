...
TECHNICAL_SOURCES = {
    ...
    for item in [
        ...
        technical_source("hardie-clearance", "James Hardie Installation Best Practices", "https://dealerkit.jameshardie.com/installation", "Manufacturer clearance guidance for siding at decks, walls, and adjacent exterior surfaces."),
        technical_source("gaf-exposed-fasteners", "GAF Steep-Slope Pro Field Guide", "https://www.gaf.com/en-us/document-library/documents/installation-instructions-%26-guides/pro-field-guide-for-steep-slope-roofs-resgn103.pdf", "Manufacturer guidance identifying exposed roof fasteners as potential leakage points; the applicable repair still depends on the installed roof system."),
        technical_source("schneider-panel-filler", "Schneider Electric Panel Filler and Knockout Instructions", "https://iportal2.schneider-electric.com/Contents/docs/SQD-HOMT220220_INSTRUCTION%20SHEET.PDF", "Manufacturer instructions showing filler plates and approved fittings for unused panel openings; exact enclosure compatibility must be confirmed."),
        technical_source("esfi-afci", "Electrical Safety Foundation International AFCI Guide", "https://www.esfi.org/afcis-protecting-your-home-from-fires/", "Independent electrical-safety guidance describing listed AFCI protection types and their function."),
...
RESEARCH_RULES = [
    ...
    research_rule(r"hard surfaces- deterioration", "moisture_envelope", "Exterior Envelope / Siding", "Exterior siding and hardscape contractor", "Patio or walk contact at siding or exterior wood can hold moisture against the wall edge and conceal deterioration. The useful repair question is how much wall material is damaged and what change to the adjacent hard surface will restore durable clearance.", "Siding and wood material, concealed damage extent, contact length, height relationship, drainage, and a feasible clearance method are unknown.", "Measure and photograph the full contact area, probe accessible siding or wood edges for deterioration, and document elevations and drainage before selecting wall repair and clearance work.", "The damage extent determines the wall repair, while the measured hardscape relationship determines whether cutting, lowering, separation, or another field-designed clearance correction is practical.", ["hardie-clearance", "homeguide-siding-repair"]),
    research_rule(r"exposed(?: roof)? fasteners", "roof", "Roof", "Roofing contractor", "Exposed roof fasteners can be leakage points, but the correct treatment depends on the roof system, fastener purpose, surrounding covering, and deck condition. A localized fastener repair is reasonable only when the surrounding assembly is sound.", "Roof system, fastener count and purpose, corrosion, seal condition, active leakage, and surrounding roof/deck condition are unknown.", "Photograph and count the exposed fasteners, identify the roof system and fastener purpose, document seal and corrosion condition, and inspect the roof underside directly below for staining or dampness.", "Roof-system identification and underside evidence determine whether localized fastener treatment is appropriate or broader roof work is needed.", ["gaf-exposed-fasteners", "homeguide-roof-minor", "angi-roof-repair"]),
    ...
    research_rule(r"unprotected knockout", "electrical", "Electrical", "Licensed electrician", "An open or oversized panel knockout leaves the enclosure incomplete. A compatible listed closure or fitting may resolve an otherwise serviceable enclosure; panel damage or an incompatible opening can require broader work.", "Opening dimensions, panel manufacturer and model, enclosure condition, compatible listed closures or fittings, and whether other panel defects are present are unknown.", "Have an electrician measure the opening, identify the panel/enclosure, and confirm whether a listed closure or fitting can restore the enclosure.", "Panel identity and compatibility decide whether this is a small enclosure repair or a broader panel correction.", ["schneider-panel-filler", "homeguide-electrical-small"]),
    research_rule(r"afci: none installed", "electrical", "Electrical", "Licensed electrician", "Absence of AFCI protection is an upgrade and applicability question, not proof that a particular retrofit method is suitable. Listed breaker and receptacle approaches exist, but panel compatibility, circuit configuration, and locally applicable requirements determine the options.", "Applicable requirements, panel compatibility, shared-neutral conditions, circuit arrangement, and circuit count are unknown.", "Have an electrician identify the affected circuits, panel and breaker compatibility, shared-neutral conditions, and locally applicable requirements before proposing AFCI protection.", "Those facts determine whether compatible breakers, another listed method, troubleshooting, or no retrofit is appropriate.", ["esfi-afci", "homeguide-afci-breaker", "homeguide-electrical-small"]),
...
RULES = [
    ...
    (r"hard surfaces- deterioration", [path("repair-contact-damage", "Repair confirmed siding or exterior wood deterioration", "homeguide-siding-repair", ["Damage is localized and accessible", "Compatible wall material is available"], ["Concealed sheathing or framing repair", "Hardscape modification", "Drainage redesign"]), path("restore-wall-clearance", "Modify the patio or walk edge to restore durable wall clearance", None, ["Field measurements confirm a practical localized correction"], ["Wall reconstruction", "Broad slab replacement", "Drainage redesign"])], ["wall material", "concealed deterioration extent", "contact length and height", "drainage condition", "feasible clearance method"]),
    (r"exposed(?: roof)? fasteners", [path("targeted-roof-fastener-repair", "Evaluate and complete a roof-system-appropriate fastener repair", "homeguide-roof-minor", ["Work remains localized", "Surrounding roof covering and deck are serviceable"], ["Decking or structural repair", "Whole-roof replacement"])], ["roof system and fastener purpose", "fastener count and corrosion", "active leakage", "concealed decking condition", "access and pitch"]),
    (r"caulking at the roof|roof jack flashing caulked", [path("targeted-roof-repair", "Evaluate and complete a localized roof repair", "homeguide-roof-minor", ["Work remains localized"], ["Decking or structural repair", "Whole-roof replacement"]), path("repair-flashing", "Repair or replace the affected flashing detail", "homeguide-roof-flashing", ["Flashing repair is localized"], ["Water-damaged sheathing or interior restoration"])], ["roof age and material", "detail dimensions", "active leakage", "concealed decking condition", "access and pitch"]),
