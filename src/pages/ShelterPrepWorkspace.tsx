...
import { isSupabaseConfigured, supabase, supabaseAnonKey, supabaseUrl } from '../lib/db/supabaseClient'
import { emptyPropertyFacts, lookupPropertyFacts, type PropertyFacts, type PropertyLookupStatus } from '../lib/db/propertyLookup'
import { buildPropertyResearchPack } from '../agents/propertyIntelligence'
import {
...
import {
  loadLocalAiResearchDrafts,
  loadLocalJobScopeSteps,
  loadLocalPropertyAgentOutputs,
  isMissingPropertyAgentOutputsTableError,
  markPropertyAgentOutputsTableUnavailable,
  propertyAgentOutputsTableUnavailable,
  quietOptionalContractorAssignmentsWarning,
  saveLocalAiResearchDrafts,
  saveLocalJobScopeSteps,
  saveLocalPropertyAgentOutputs,
  sortJobExecutionSteps,
} from '../lib/db/localStorageKeys'
import type {
  AdminNote,
  AdminNoteDraft,
  AdminNoteType,
  ...
  AgentMemoryAuditLog,
  AgentMemoryConflict,
  AgentMemoryConflictStatus,
  AgentName,
  AgentResearchCategory,
  AgentResearchQuestionDraft,
  AgentResearchQuestionType,
  AgentResearchScope,
  AgentResearchSource,
  AgentResearchSourceQuality,
  AgentResearchSourceType,
  AgentResearchTask,
  AgentResearchTaskStatus,
  AgentRuleApplication,
  AgentRuleApplicationFeedbackStatus,
  AgentRuleApplicationType,
  AiEstimate,
  AiResearchDraft,
  AiResearchDraftStatus,
  ContractorAssignment,
  ContractorAssignmentStatus,
  ContractorProfile,
  CorrectionCategory,
  CorrectionLearningEvaluation,
  CorrectionLearningInput,
  CuratedLaborDraft,
  CuratedLessonIntakeDraft,
  EstimateItem,
  EstimateResearchRow,
  EvidenceInspectionStatus,
  EvidenceResearchDraft,
  EvidenceType,
  FastReviewStatus,
  HumanPricingMemory,
  InspectionProcessingStatus,
  InspectionReportDraft,
  InspectionTaskIntelligence,
  IntakeDraft,
  Invoice,
  InvoiceCostAnalysis,
  JobExecutionStep,
  JobExecutionStepAction,
  JobExecutionStepLearningRecord,
  JobExecutionStepStatus,
  JobPacketMetadata,
  LaborRate,
  LaborSourceLink,
  LeadPropertyProfile,
  LearningRuleApplicationContext,
  LessonExtractionResult,
  LessonStatus,
  ManualMaterialDraft,
  MaterialComplexityClassification,
  MaterialCost,
  MaterialEditorDraft,
  MaterialEstimateDraftLine,
  MaterialListComplexity,
  ...
  PropertyMediaConfidence,
  PropertyMediaFinding,
  PropertyMediaReviewStatus,
  RequestEditDraft,
  RequestStatus,
  ReviewPacketMetadataFields,
  SellerPrepAnalysisV1,
  SellerPrepItemV1,
  SourceConfirmationStatus,
  SourceLesson,
  SourceLessonComprehensionGrade,
  SourceLessonConfidence,
  SourceLessonDraft,
  SourceLessonHumanReviewStatus,
  SourceLessonLink,
  SourceLessonMemoryDestination,
  SourceLessonSourceType,
  SourceLessonStatus,
  SourceReportVisibility,
  SourceResearchSetupDraft,
  StoredFile,
  Tab,
  UploadEvidenceCategory,
  UploadEvidenceStatus,
  WorkRequest
} from '../types/app'
...
export default function ShelterPrepWorkspace() {
