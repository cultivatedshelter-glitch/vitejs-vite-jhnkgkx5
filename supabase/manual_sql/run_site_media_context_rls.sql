-- Manual SQL fallback for 202605240001_site_media_context_rls.sql.
-- Affects public.property_media_analysis and public.property_media_findings.
-- Replaces the broad estimator read/create draft policies with context-scoped
-- read/create draft policies that inherit access from lead/property/source-file context.
-- Does not drop tables or functions; only drops/recreates the intended RLS policies.
-- Safe to run after the base Site Media Intelligence tables and role helper functions exist.
